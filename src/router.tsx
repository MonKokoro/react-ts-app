 ...
 * A：也跟动画系统有关。由于本系统中切换页面时，上一个页面存在切出动画，但路由的切换是立即完成的。如果在Layout组件中获取当前路由的实例，会导致上一个页面还未切出完毕，就已经被修改成了新页面，从而造成视觉上的bug
 * 
 * Q：createBrowserRouter和BrowserRouter有什么区别
 * A：createBrowserRouter是React Router v6.4的更新，其实无非是从写节点变成了写js，个人感觉是比以前的BrowserRouter好用一些。但这次更新说实话争议挺多的，因为塞了很多看起来不属于路由的功能（表单请求、路由请求等），包体一下子大了很多，挺多人觉得这就是依托答辩……嘛，见仁见智吧，说不定哪一天这些新功能就派上用场了呢
*/
